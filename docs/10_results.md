...
<!-- Experiment/run results log, newest-relevant-first. Each entry: config -> metrics ->
     takeaways -> caveats. "What actually happened" (plans live in 04_plan.md). Label entries
     R1, R2, ... -->
...
The first entry here (`R1`) should be this project's own fine-tuning run once submitted
(`04_plan.md` step 3), then a serving/rollout entry once step 5 happens.
